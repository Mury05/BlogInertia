        ...
        <section>
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                <div class="bg-white p-4 shadow sm:rounded-lg sm:p-8">
                    ...
                    <form @submit.prevent="form.put(route('dashboard.users.update', { user: user.id }), {
                        onSuccess: () => {
                            form.reset();
                            Swal.fire({
                                icon: 'success',
                                title: 'Succès!',
                                text: 'Rôle de l\'utilisateur modifié avec succès.',
                        ...
                        <div>
                            <div class="flex items-center">
                                <Checkbox class="mx-3 cursor-pointer" name="isAdmin" v-model="form.isAdmin"
                                    :checked="form.isAdmin == 1 ? true : false" /> <!-- Utilisez v-model ici -->
